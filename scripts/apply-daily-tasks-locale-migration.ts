/**
 * Applies the daily_tasks locale migration using a direct Postgres URL.
 *
 * Usage:
 *   SUPABASE_DB_URL="postgresql://postgres.[ref]:[password]@...supabase.com:5432/postgres" \
 *     npx tsx scripts/apply-daily-tasks-locale-migration.ts
 *
...
async function main() {
  ...
  try {
    ...
    console.log("Applied daily_tasks locale migration successfully.");
  } finally {
